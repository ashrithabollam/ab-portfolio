      ...
      <div className="max-w-7xl mx-auto x-4 sm:px-6 lg:px-8 px-4">
        ...
        <div className="flex justify-between items-center md:items-stretch flex-col md:flex-row pb-24">
          ...
          <div className="w-full md:pr-8">
            <form action="mailto:ashrithabollam21@gmail.com" method="POST" encType="text/plain">
              <div className="my-6">
                <label
                  htmlFor="name"
                  className={
              ...
              <div className="flex justify-between items-center mt-6">
                <a
                  href="mailto:ashrithabollam21@gmail.com"
          ...
          <div className="w-full flex flex-col md:items-end mt-12 md:mt-6">
            ...
            {/* Resume Button */}
            <a
              href="/ASHRITHA_BOLLAM_Resume.pdf"
              download
              className="mt-6 bg-blue-600 text-white font-semibold px-6 py-2 rounded-lg hover:bg-blue-700"
            >
              Download Resume
            </a>
          </div>
